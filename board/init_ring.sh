#!/bin/sh
# /mnt/flash/init_ring.sh — aero_ring.ko (ring mode) 버전
/mnt/nfs/aero_eth_app --ptp --stop; sleep 2
rmmod aero; sleep 2
ifconfig eth0 192.168.7.113; sleep 2
mount -t nfs 192.168.7.202:/volume1/Shared /mnt/nfs; sleep 2
cd /mnt/nfs; sleep 2
insmod aero_ring.ko; sleep 2
...
./aero_eth_app --ptp --start --slave --hwts --mode="ring" \
               --maxadjoffset=4000000 --maxadjfrq=520000 --ccw --kalman; sleep 2
